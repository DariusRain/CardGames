...
* <h1>BlackJack</h1>
* <p>
 *   Blackjack commandline game, where multiple players can play the dealer.
 *</p>
 *
 * @author  Darius Rain
 * @version 2.5
...
//        *     @see blackjack.main.utils.generators.CardGenerator#nextCard()  <br\>
//        *     @see blackjack.main.materials.Deck#draw() <br\>
...
//        *     @see java.util.Set
//        *     @see blackjack.main.materials.Deck#draw()
//        *
//        * v1.1 Determine the value of the hand based on the values
//        * v1.2 Determine the BlackJack value of the hand.
//        *     @see main.games.blackjack.Hand#countCards()
//        *     @see main.games.blackjack.Hand#hit(java.lang.String, boolean)
//        *     @see blackjack.main.utils.UserInteractions.Parser#cardValue(java.lang.String)
//        *
//        * v1.3 Draw another card into the hand and determine if a Bust has occurred.
//        *     @see main.games.blackjack.Hand#didBust()
//        *
//        * v1.4 End my turn.
...
//        *     @see blackjack.main.utils.UserInteractions.Menu#choice(java.lang.String)
//        *
//        * v2.4 Bet points.
